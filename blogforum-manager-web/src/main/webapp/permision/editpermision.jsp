...
<body>
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h4><i class="icon-user"></i> 修改权限</h2>
					</div>
                    <div class="ibox-content" style="width:75%;padding-left:20px">
                        <form class="form-horizontal m-t" id="commentForm">
                            <div class="form-group" style="margin-left:10%">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="name" placeholder="输入权限名" class="form-control">
                                </div>
                            </div>
                            <div class="form-group" style="margin-left:10%">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="controller" placeholder="输入请求路径" class="form-control">
                                </div>
                            </div>
			...
			$.get("get.action",{
				...
				if(data.status != "200"){
					...
					$("#controller").val(data.data.controller);
				}
			})
