...
<body>
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h4><i class="icon-user"></i> 新增权限关联</h2>
					</div>
                    <div class="ibox-content" style="width:75%;padding-left:20px">
                        <form class="form-horizontal m-t" id="commentForm">
                            ...
                            <div class="form-group" style="margin-left:10%">
                                ...
                                <div class="col-sm-10">
										<input type="text" style="float: left" class="form-control" id="permisionname" autocomplete="off" data-provide="typeahead" style="width: 210px;height: 30px;margin-left: 10px;margin-top: 3px"  placeholder="搜索权限名" / >
										<input type="hidden" id="permisionid" style="float: left;">
                                </div>
                            </div>
			...
			$('#permisionname').typeahead({
		        ...
		        updater: function (obj) {
		            var item = JSON.parse(obj);
		            $("#permisionid").attr("value",item.id);
		            return item.name;
		        }
			})
			...
			$("#add").click(function(){
				...
				var permisionid = $("#permisionid").attr("value");
				if(!permisionid){
					layer.msg("未搜索到该权限");
					return false;
				}
